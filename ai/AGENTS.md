...
```bash
gh run view <RUN_ID> --repo sebiboga/tec-software-solutions-srl-nodejs-scraper --json status -q .status
```
...
**On every session:**
1. Check open GitHub issues: `gh issue list --repo sebiboga/tec-software-solutions-srl-nodejs-scraper --state open`
