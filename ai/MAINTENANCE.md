...
```bash
gh issue list --repo peviitor-scrapers/tec-software-solutions-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "TEC Agency", not the old template
