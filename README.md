# job_seeker_ro_spider — Qualitest Scraper

[![Oportunitati SI Cariere](https://github.com/peviitor-scrapers/tec-software-solutions-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml/badge.svg)](https://github.com/peviitor-scrapers/tec-software-solutions-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml)
[![Automation Tests](https://github.com/peviitor-scrapers/tec-software-solutions-srl-nodejs-scraper/actions/workflows/automation-testing.yml/badge.svg)](https://github.com/peviitor-scrapers/tec-software-solutions-srl-nodejs-scraper/actions/workflows/automation-testing.yml)

[![Version](https://img.shields.io/github/package-json/v/peviitor-scrapers/tec-software-solutions-srl-nodejs-scraper?label=version&color=blue)](CHANGELOG.md)
[![Test Results](https://img.shields.io/badge/test--results-HTML-9b59b6)](https://peviitor-scrapers.github.io/tec-software-solutions-srl-nodejs-scraper/test-results/)
...
[![GitHub Pages](https://img.shields.io/github/deployments/peviitor-scrapers/tec-software-solutions-srl-nodejs-scraper/github-pages?label=GitHub%20Pages)](https://peviitor-scrapers.github.io/tec-software-solutions-srl-nodejs-scraper/)

**job_seeker_ro_spider** — un scraper pentru job-urile TEC SOFTWARE SOLUTIONS SRL din România. Extrage anunțurile de pe [TEC Agency Careers](https://tecss.bamboohr.com/careers/) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul Peviitor.
...
Proiectul automatizează colectarea zilnică a job-urilor TEC Agency din România, menținând board-ul peviitor.ro la zi cu cele mai recente oportunități de carieră.

## Features

- Extrage job-uri de pe TEC Agency Careers BambooHR JSON API (`/list`)
...
│   ├── e2e/                        # E2E tests (real QualityAI search)
...
This scraper respects the rules from [robots.txt](https://tecss.bamboohr.com/robots.txt) of TEC BambooHR Careers.

**Key points:**
- The `/careers/list` API is **allowed** by robots.txt (only `/jobs/embed.php` and `/jobs/embed2.php` are disallowed)
